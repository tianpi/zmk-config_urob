...
#define KEYS_LEFT_HAND LT0 LT1 LT2 LT3 LT4 LM0 LM1 LM2 LM3 LM4 LB0 LB1 LB2 LB3 LB4  // Left-hand keys.
#define KEYS_RIGHT_HAND RT0 RT1 RT2 RT3 RT4 RM0 RM1 RM2 RM3 RM4 RB0 RB1 RB2 RB3 RB4  // Right-hand keys.
#define KEYS_LEFT_AND_RIGHT_THUMB LH2 LH1 LH0 RH0 RH1 RH2                                      // Thumb keys.
...
ZMK_HOLD_TAP(hml,
    ...
    bindings = <&kp>, <&kp>;
    hold-trigger-key-positions = <KEYS_RIGHT_HAND KEYS_LEFT_AND_RIGHT_THUMB>;
...
ZMK_HOLD_TAP(hmr,
    ...
    require-prior-idle-ms = <150>;
    bindings = <&kp>, <&kp>;
    hold-trigger-key-positions = <KEYS_LEFT_HAND KEYS_LEFT_AND_RIGHT_THUMB>;
    hold-trigger-on-release;
)
```
